...
const Projects = () => {
  ...
  return (
    <div className='smf__projects' id='Projects'>
      <div className={inView ? 'smf__projects-header fade-in':'smf__projects-header fade-out-fast'} >
        <h1>
          Projects
        </h1>
        <p ref={ref}>
      ...
      <div ref={reftwo} className={inViewtwo ? 'smf__projects-content fade-in':'smf__projects-content fade-out-fast'}>
